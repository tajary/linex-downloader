...
//__("Downloads files from web and puts them in the uploads folder", "linex-doenloader");
//__("Linex Downloader", "linex-doenloader");
//__("Alireza Tajary", "linex-doenloader");
/**
 * wp_verify_nonce( 'ACTION', 'FIELD' );
 * wp_nonce_url( $URL, 'ACTION','FIELD' )
 * wp_nonce_field( 'ACTION', 'FIELD' )
 * 
 * esc_
 *	attr , html , textarea , js , sql , url , and url_raw
...
__("Linex Downloader","linex-downloader");
__("Downloads files from web and puts them in the uploads folder","linex-downloader");
__("Alireza Tajary","linex-downloader");
